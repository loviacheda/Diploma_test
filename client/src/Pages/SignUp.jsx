...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
   ...
   /* try {
     ...
     if (res && res.data) {
      console.log(res.data); // Отримані дані з відповіді
      // Інші дії з отриманими даними, якщо необхідно
  } else {
      console.log("Отримано пусту відповідь або немає даних від сервера");
  }
    } catch (error) {
